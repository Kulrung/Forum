...
$comments = $db->query('SELECT comments.comments_id, comments.text AS text, topics.name AS topic_name, categories.name AS category_name, users.username AS username, comments.created AS created, comments.updated AS updated
                              ...
                              WHERE users_id=1 ;')->fetchAll(PDO::FETCH_ASSOC);
if (!empty($comments)){
